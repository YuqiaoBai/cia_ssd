...
def draw_box_plt(boxes_dec, ax, color='red', linewidth_scale=1.0):
    """
    ...
    print('theta:', theta, np.cos(theta), np.sin(theta))
...
gt_boxes = torch.Tensor([[0,0,0,4,2,0,-180]])
