...
from ops.nms.nms_cpu import rotate_nms_cc, rotate_weighted_nms_cc
...
def second_box_encode(
    boxes, anchors, encode_angle_to_vector=False, encode_angle_with_residual=False,
        smooth_dim=False, norm_velo=False
):
